...
webui_admin_conf='Release/23.0.4/webui/install/bareos/bareos-dir.d/profile/webui-admin.conf'
admin_conf='Release/23.0.4/webui/install/bareos/bareos-dir.d/console/admin.conf.example'
