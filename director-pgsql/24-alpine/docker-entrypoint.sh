...
webui_admin_conf='Release/24.0.7/webui/install/bareos/bareos-dir.d/profile/webui-admin.conf'
admin_conf='Release/24.0.7/webui/install/bareos/bareos-dir.d/console/admin.conf.example'
